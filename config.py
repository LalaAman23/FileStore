...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8252868529:")
...
OWNER = os.environ.get("OWNER", "MentalJiraya") # Owner username without @
...
DB_NAME = os.environ.get("DATABASE_NAME", "Aman")
#--------------------------------------------
